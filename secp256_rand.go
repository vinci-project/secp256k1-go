...
import (
	...
	blake "golang.org/x/crypto/blake2b"
...
func SumBLAKE2b256(b []byte) []byte {
	sum := blake.Sum256(b)
	return sum[:]
}
...
func (self *EntropyPool) Mix256(in []byte) (out []byte) {
	...
	//hash input
	val1 := SumBLAKE2b256(in)
	//return value
	val2 := SumBLAKE2b256(append(val1, self.Ent[:]...))
	//next ent value
	val3 := SumBLAKE2b256(append(val1, val2...))
